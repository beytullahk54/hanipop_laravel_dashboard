...
import ItalyanTema from '../components/ItalyanTema';
            ...
            if (query.url) {
                let response = await axios.post(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/kategoriGetir`, {
                    ...
                    if (res.data) {
                        ...
                        if(res.data.firma.menu_type == "type3")
                        {
                            location.href="/?url=viyana-kahvesi"   
                        }
                        setIsLoading(false);
                    ...
                    {kalanGun > 0 &&
                        <>
                            ...
                            {firma && firma.menu_type != 'type2' && 
                               <>
                                    <main>
                                        <HeaderHome firma={firma}  ></HeaderHome>
                                        ...
                                        <CardList seciliDil={seciliDil} setSeciliDil={setSeciliDil} datas={datas} />
